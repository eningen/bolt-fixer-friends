...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      notifications: { Row: { actor_id: string | null; created_at: string; id: string; read: boolean; type: Database["public"]["Enums"]["notification_type"]; updated_at: string; user_id: string; video_id: string | null }; Insert: { actor_id?: string | null; created_at?: string; id?: string; read?: boolean; type: Database["public"]["Enums"]["notification_type"]; updated_at?: string; user_id: string; video_id?: string | null }; Update: { actor_id?: string | null; created_at?: string; id?: string; read?: boolean; type?: Database["public"]["Enums"]["notification_type"]; updated_at?: string; user_id?: string; video_id?: string | null }; Relationships: [] }
      posts: { Row: { body: string; created_at: string; id: string; updated_at: string; user_id: string }; Insert: { body: string; created_at?: string; id?: string; updated_at?: string; user_id: string }; Update: { body?: string; created_at?: string; id?: string; updated_at?: string; user_id?: string }; Relationships: [] }
      profiles: { Row: { avatar_url: string | null; bio: string | null; created_at: string; display_name: string; id: string; updated_at: string; username: string }; Insert: { avatar_url?: string | null; bio?: string | null; created_at?: string; id: string; display_name: string; username: string }; Update: { avatar_url?: string; bio?: string; display_name?: string; id?: string; username?: string }; Relationships: [] }
