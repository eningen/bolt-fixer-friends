...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      profiles: { Row: { avatar_url: string | null; bio: string | null; created_at: string; display_name: string; id: string; updated_at: string; username: string }; Insert: { avatar_url?: string | null; bio?: string | null; created_at?: string; id: string; display_name: string; username: string }; Update: { avatar_url?: string | null; bio?: string | null; created_at?: string; id?: string; display_name?: string; username?: string }; Relationships: [] }
