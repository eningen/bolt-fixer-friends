  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          問題が発生しました。再読み込みするか、ホームに戻ってください。
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Stickman video｜棒人間動画SNS" },
      {
        name: "description",
        content: "棒人間アニメーションを投稿して共有できるSNS。再生数といいねのランキングも。",
      },
      { property: "og:title", content: "Stickman video｜棒人間動画SNS" },
      {
      ...
      { name: "apple-mobile-web-app-title", content: "Stickman" },
    ],
    links: [
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <LanguageProvider>
        <SideNav />
      <div className="pb-14 md:pb-0 md:pl-20">
